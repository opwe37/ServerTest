Rails.application.routes.draw do
  ...
  post   'owner/truck_info_save'        => 'owner#truck_info_save'
  ...
  get   'common/request_ReviewComments' #=> 'common#request_ReviewComments'
